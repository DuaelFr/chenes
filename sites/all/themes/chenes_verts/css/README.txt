...
To use these stylesheets, rename the files and chenes_verts with the name of your theme.
...
chenes_verts-alpha-default.css
...
chenes_verts-alpha-default-narrow.css  
...
chenes_verts-alpha-default-normal.css
...
chenes_verts-alpha-default-wide.css
